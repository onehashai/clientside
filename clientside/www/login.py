...
def get_context(context):
    ...
    context["app_name"] = (
        frappe.get_hooks("brand_name")[-1] or frappe.get_system_settings("app_name") or _("Frappe")
    )
    ...
    has_valid_subscription = stripe_subscription_manager.has_valid_subscription_v2(frappe.conf.customer_id,"ONEHASH")
    context["has_valid_subscription"] = has_valid_subscription
    print("has_valid_subscription",has_valid_subscription)
